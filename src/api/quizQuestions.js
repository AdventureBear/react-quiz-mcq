var quizQuestions = [
    ...
    answers: [
      {
        ...
        content: "Esmolol",
        correct: true,
        discussion: "The primary goal in the medical management of an acute aortic dissection is to decrease the blood pressure and heart rate to minimize the aortic shearing force that could worsen the intimal tear and further propagate the dissection. Beta-blockers such as esmolol or labetalol should be given first. They effectively reduce blood pressure and shearing force but additionally prevent the reflex tachycardia that occurs with primary administration of vasodilators. The goal systolic blood pressure is 100 to 120 mm Hg, and the goal heart rate is less than 60 beats/min. Note that the blood pressure goal is independent of the patient’s baseline blood pressure, unlike the approach to most hypertensive emergencies."
      },
      {
        id: 2,
        content: "Nicardipine",
        correct: false,
        discussion: "Nicardipine is a vasodilator. It is part of the treatment for an acute aortic dissection, but it should be added after the beta-blocker. Increased heart rate is a common side effect of vasodilator therapy, so it should not be the first medication given."
      },
      {
        id: 3,
        content: "Nifedipine",
        correct: false,
        discussion: "Nifedipine is a calcium channel blocker and vasodilator. It can be used as part of the treatment for an acute aortic dissection, but it should be added after the beta-blocker. As with nicardipine, it can increase heart rate and should not be the first medication given."
      },
      {
        id: 4,
        content: "Nitroprusside",
        correct: false,
        discussion: "Nitroprusside also is a vasodilator and should be administered after a beta-blocker."
      }
    ],
    source: "Peer",
    references: [
  ...
  },
  {
    ...
    answers: [
      {
        id: 1,
        content: "Blood cultures are an effective means of identifying patients with active disease",
        correct: false,
        discussion: "The B. pertussis organism is a small, aerobic, gram-negative coccobacilli that occurs singly or in pairs. It adheres preferentially to ciliated respiratory epithelial cells. The organism produces several toxins that act locally and systemically. These toxins include pertussis toxin, dermonecrotic toxin, adenylate cyclase toxin, and tracheal cytotoxin. B. pertussis does not invade beyond the submucosal layer in the respiratory tract and is almost never recovered in the bloodstream. "
      },
      {
        id: 2,
        content: "Identifying disease in infants is difficult because apnea can be the only symptom",
        correct: true,
        discussion: "Pertussis is the acute and highly contagious respiratory infection caused by B. pertussis. Infected infants do not typically develop the characteristic “whooping” cough, and they can present with apneic episodes as the sole symptom, without fever. In fact, even among adults, only one-third of patients develop the characteristic cough. Pertussis arises in three distinct, sequential clinical stages: the catarrhal phase, paroxysmal phase, and convalescent phase. The catarrhal, or prodromal, phase begins after an incubation period of approximately 7 to 10 weeks and lasts approximately 1 to 2 weeks. In this early phase, the signs and symptoms include rhinorrhea, a low-grade fever, malaise, conjunctival injection, and in some, apnea. A dry cough usually begins at the end of the catarrhal phase. The paroxysmal phase begins as the fever subsides and the cough increases. Paroxysms of staccato coughing occur 40 to 50 times per day. The patient coughs repeatedly in short exhalations, followed by a single, sudden, forceful inhalation that produces the characteristic “whoop.” This phase lasts 1 to 6 weeks or perhaps longer. Recovery from pertussis is gradual; the convalescent stage lasts 2 to 3 weeks. Coughing subsides, but many patients remain susceptible to other respiratory infections."
      },
      {
        id: 3,
        content: "Previous infection confers lifelong immunity for subsequent infection or disease",
        correct: false,
        discussion: "Vaccination and previous infection do not confer lifelong immunity. Patients require five doses of the DTaP vaccine at ages 2, 4, and 6 months, then again between 15 and 18 months and between 4 and 6 years. Then, every 10 years, a booster with Tdap is required to continue immunity. A booster immunization may be required sooner than every 10 years if the patient is exposed to tetanus. Since 1990, the number of B. pertussis cases has increased, particularly in the adolescent population, most likely as a result of waning immunity and a lack of compliance with episodic booster immunization recommendations."
      },
      {
        id: 4, content: "Treatment to prevent infectivity is most effective during the paroxysmal phase",
        correct: false,
        discussion: "Infectivity is greatest during the catarrhal phase (not the paroxysmal phase). The catarrhal phase begins after a 7- to 10-week incubation period and lasts approximately 1 to 2 weeks. During this time, the disease is clinically indistinguishable from other upper respiratory tract infections."
      }
    ],
  source: "Peer",
  references: [
  ...
  },
  {
    ...
    answers: [
      {
        id: 1,
        content: "Approximately 20 mg/dL is eliminated per hour in nontolerant individuals",
        correct: true,
        discussion: "In general, unless the patient has developed a tolerance for ethanol, about 20 mg/dL is eliminated per hour. Alcohol dehydrogenase and the specific cytochrome P450 are the enzymes that metabolize most of the ethanol. Both enzymes are inducible, which is why rates of ethanol metabolism are actually higher in chronic drinkers, at an estimated 30 mg/dL per hour. "
      },
      {
        id: 2,
        content: "Cytochrome P450 is responsible for the majority of metabolism",
        correct: false,
        discussion: "Hepatic alcohol dehydrogenase is the major enzyme responsible for initial ethanol metabolism. A specific cytochrome P450 also metabolizes ethanol but is a minor pathway."
      },
      {
        id: 3,
        content: "Elimination occurs predominantly by renal metabolism",
        correct: false,
        discussion: "Elimination of ethanol is predominantly by hepatic (not renal) metabolism. Smaller amounts leave the body in sweat and urine.",
      },
      {
        id: 4,
        content: "It is characterized by zero-order kinetics at lower concentrations",
        correct: false,
        discussion: "Zero-order kinetics is the term used to characterize the metabolism of a substance at a fixed amount per hour. This rate of metabolism is rare; with regard to ethanol, it occurs in high concentrations when the enzymes become saturated, which is the case with chronic users and alcoholics. More commonly, among persons with low concentrations of ethanol in the blood and those who are nontolerant, metabolism follows first-order kinetics — a fixed percentage of total ethanol is metabolized per hour."
      }
    ],
    source: "Peer",
    references: [
